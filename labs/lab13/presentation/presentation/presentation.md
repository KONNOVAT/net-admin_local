...
![Первоначальная настройка коммутатора msk-hostel-takonnova-sw-1](image/9.png){#fig:094 width=70%}
...
![Первоначальная настройка маршрутизатора sch-sochi-takonnova-gw-1](image/11.png){#fig:096 width=70%}
